...
const Reservation = () => {
  ...
  return (
    <div>
      ...
      <button className="button" onClick={toggleToBeAdmin}>관리자 모드 전환</button>
      <input className="input" type="text" placeholder="별명" onChange={updateNickname} />
      <input className="input" type="text" placeholder="이메일" onChange={updateEmail} />
    </div>
  );
};
